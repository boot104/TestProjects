    ...
    (function (QueryBuilder) {
        ...
        ko.bindingHandlers['dxdTableView'] = {
            init: function (element, valueAccessor, allBindings, viewModel, bindingContext) {
                var templateHtml = $('#dxd-tableview').text(), $element = $(element).append(templateHtml), value = ko.unwrap(valueAccessor());
                ko.applyBindings({
                    data: value,
            ...
            var DataSourceParameter = (function (_super) {
                ...
                DataSourceParameter.prototype._updateValueInfo = function (newType) {
                    ...
                    this._valueInfo($.extend({}, Data.parameterValueSerializationsInfo, {
                        editor: Analytics.Internal.getEditorType(typeValue.name),
...
(function (DevExpress) {
    ...
    (function (Analytics) {
        var Data;
        (function (Data) {
            function getDBSchemaCallback(connection, table) {
                var deferred = $.Deferred();
                DevExpress.QueryBuilder.Utils.RequestWrapper.getDbSchema(connection, table)
                    .done(function (data) {
            ...
            function getDBStoredProceduresCallback(connection) {
                var deferred = $.Deferred();
                DevExpress.QueryBuilder.Utils.RequestWrapper.getDbStoredProcedures(connection)
                    .done(function (data) {
    ...
    (function (Analytics) {
        ...
        (function (Data) {
            ...
            var SqlDataSource = (function (_super) {
                ...
                function SqlDataSource(model, serializer) {
                    var _this = this;
                    _super.call(this);
                    serializer = serializer || new Analytics.Utils.ModelSerializer();
        ...
        (function (Elements) {
            var QueryViewModel = (function (_super) {
                ...
                function QueryViewModel(querySource, dbSchemaProvider, parametersEditingEnabled, serializer) {
                    ...
                    this.parameters = DevExpress.Analytics.Utils.deserializeArray(querySource["Parameters"], function (item) { return new DevExpress.Data.DataSourceParameter(item, serializer); });
                    this.editableName = ko.observable(this.name());
                    this.name = ko.pureComputed({
                        read: this.editableName,
                        write: function (val) { }
                    });
                    this.filterString = new DevExpress.Analytics.Widgets.FilterStringOptions(this._filterString, null, ko.pureComputed(function () { return (_this.tables().length === 0) && (_this.filterString && _this.filterString.value().length === 0); }));
                    ...
                    this._disposables.push(ko.computed(function () {
                        if (!inProcess) {
                            ...
                            if (allColumns.length !== withoutAggregate.length) {
                                ...
                                allColumns.filter(function (x) { return x.groupBy.peek(); }).forEach(function (x) { return x.groupBy(false); });
                            }
                            inProcess = false;
                        }
                    }));
                    this.groupFilterString = new DevExpress.Analytics.Widgets.FilterStringOptions(this._groupFilterString, null, ko.pureComputed(function () { return !_this.columns().some(QueryBuilder.Widgets.isAggregatedExpression) && (_this.groupFilterString && _this.groupFilterString.value().length === 0); }));
                    this._initializeFilterStringHelper(this.groupFilterString.helper, this.parameters, parametersEditingEnabled, new QueryBuilder.Widgets.GroupFilterEditorSerializer(this.columns));
                ...
                QueryViewModel.prototype._initializeFilterStringHelper = function (helper, parameters, parametersEditingEnabled, serializer) {
                    ...
                    helper.mapper.Parameter = QueryBuilder.Widgets.OperandParameterQBSurface;
                    helper.mapper.Property = QueryBuilder.Widgets.OperandPropertyQBSurface;
                    ...
                    if (!parametersEditingEnabled) {
                        ...
                        helper.criteriaTreeValidator._checkRightPart = function (criteriaOperator) {
                            return !(criteriaOperator instanceof DevExpress.Analytics.Criteria.OperandParameter) && oldCheckRightPart(criteriaOperator);
                        };
                    }
                };
        ...
        (function (Elements) {
            var QuerySurface = (function (_super) {
                ...
                function QuerySurface(query, zoom) {
                    ...
                    this.placeholder = function () { return DevExpress.Analytics.getLocalization('Drop a table or view here to create a query.', 'QueryBuilder_SurfacePlaceholder'); };
    ...
    (function (QueryBuilder) {
        ...
        function createQueryBuilder(element, data, callbacks, localization, rtl) {
            ...
            var initQuery = function (querySource) {
                query(new QueryBuilder.Elements.QueryViewModel(querySource, data.dbSchemaProvider(), !!data.parametersEditingEnabled));
            };
            ...
            var previewPopupContainer = function (element) { return $(element).closest('.dx-viewport'); };
            ...
            var tablesTop = ko.observable(355);
            designerModel.tabPanel.tabs.length = 0;
            designerModel.tabPanel.tabs.push(new DevExpress.Analytics.TabInfo("Properties", "dxqb-properties-wrapper", {
                caption: ko.pureComputed(function () {
                    ...
                    switch (focused && focused.getControlModel().controlType) {
                        ...
                        default:
                            ...
                            id = "ASPxReportsStringId.ReportDesigner_QueryBuilder_SelectionProperties";
                    }
                ...
                tablesTop: tablesTop,
                dbObjectsListTitle: function () { return DevExpress.Analytics.getLocalization("Available tables and views", "ASPxReportsStringId.ReportDesigner_QueryBuilder_AvailableTables"); },
            ...
            designerModel.tabPanel.resizable = function (el) {
                return {
                    starting: function () { $(el).css('left', ''); },
                    stopped: function () { },
                    handles: 'w',
                    resize: function () {
                        $(el).css('right', '1px').css('left', '');
                        designerModel.tabPanel.width($(el).width());
                    },
                    zoom: 1,
                    minWidth: 325,
                    maxWidth: 1000
            ...
            designerModel.dataBindingsProvider = designerModel.fieldListProvider = new QueryBuilder.Widgets.QueryBuilderObjectsProvider(query, QueryBuilder.Widgets.QueryBuilderObjectsProvider.whereClauseObjectsFilter);
            ...
            designerModel.showStatement = function () {
                ...
                QueryBuilder.Utils.RequestWrapper.getSelectStatement(data.dbSchemaProvider().connection, JSON.stringify(query().serialize(true))).done(function (data) {
    ...
    (function (QueryBuilder) {
        ...
        (function (Utils) {
            var RequestWrapper = (function () {
                ...
                RequestWrapper.sendRequest = function (action, arg) {
                    return DevExpress.Analytics.Utils.ajax(QueryBuilder.HandlerUri, action, arg);
                };
                ;
                RequestWrapper.getDbSchema = function (connection, table) {
                ...
                RequestWrapper.getSelectStatement = function (connection, queryJSON) {
                    ...
                    return RequestWrapper.sendRequest("getSelectStatement", encodeURIComponent(requestJson));
                };
                RequestWrapper.getDataPreview = function (connection, queryJSON) {
                    var serializer = new DevExpress.Analytics.Utils.ModelSerializer();
                    var requestJson = JSON.stringify({
                        connectionJSON: RequestWrapper.getConnectionJSON(connection),
                        sqlQueryJSON: queryJSON
                    });
                    return RequestWrapper.sendRequest("getDataPreview", encodeURIComponent(requestJson));
                };
                RequestWrapper.getConnectionJSON = function (connection) {
                    var serializer = new DevExpress.Analytics.Utils.ModelSerializer();
            ...
            var QueryBuilderObjectsProvider = (function () {
                function QueryBuilderObjectsProvider(query, objectFilter) {
                    ...
                    this.createParameter = function (name, dataType) {
                        if (name !== "" && name !== Widgets.OperandParameterQBSurface.defaultDisplay() && query().parameters().filter(function (parameter) { return parameter.name() === name; }).length === 0) {
    ...
    (function (QueryBuilder) {
        ...
        (function (Widgets) {
            var MasterDetailEditor = (function () {
                ...
                MasterDetailEditor.prototype.getPopupContainer = function (el) { return $(el).closest('.dx-viewport'); };
                ;
        ...
        (function (Wizard) {
            var MultiQueryConfigurePage = (function (_super) {
                ...
                function MultiQueryConfigurePage(wizard, callbacks, disableCustomSql, rtl) {
                    ...
                    this._sqlTextProvider = new Wizard.Utils.SelectQuerySqlTextProvider(this._callbacks.selectStatement || DevExpress.QueryBuilder.Utils.RequestWrapper.getSelectStatement, this._dataConnection);
                    this.popupQueryBuilder = new Wizard.Utils.QueryBuilderPopup(function (newQuery, isInProcess) { return _this.setTableQuery(newQuery, isInProcess); }, rtl);
                ...
                MultiQueryConfigurePage.prototype.beginAsync = function (data) {
                    ...
                    if (this._data !== data || data.connectionString() !== this._connection) {
                        this._dataSourceClone = new Analytics.Data.SqlDataSource({});
        ...
        (function (Wizard) {
            var MultiQueryDataSourceWizardModel = (function () {
                function MultiQueryDataSourceWizardModel() {
                    ...
                    this.sqlDataSource = new Analytics.Data.SqlDataSource({});
        ...
        (function (Wizard) {
            var WizardViewModel = (function () {
                ...
                WizardViewModel.prototype.wizardPopupPosition = function (element) {
                    return {
                        of: $(element).closest('.dx-viewport')
                    };
                };
            ...
            var MultiQueryDataSourceWizard = (function (_super) {
                ...
                function MultiQueryDataSourceWizard(connectionStrings, callbacks, disableCustomSql, rtl) {
                    ...
                    this.steps = [
                        ...
                        new Wizard.MasterDetailRelationsPage(this, callbacks.sqlDataSourceResultSchema || DevExpress.QueryBuilder.Utils.RequestWrapper.rebuildResultSchema)
                    ];
                }
            ...
            (function (Utils) {
                var QueryBuilderPopup = (function () {
                    ...
                    QueryBuilderPopup.prototype.popupViewModel = function (element) {
                        var $container = $(element).closest('.dx-viewport');
                        return {
